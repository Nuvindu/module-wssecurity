...
public class Request {
    ...
    public static void setSecurityHeader(BObject request, BObject securityHeader) throws WSSecurityException {
        BHandle handle = (BHandle) securityHeader.get(StringUtils.fromString("nativeSecHeader"));
